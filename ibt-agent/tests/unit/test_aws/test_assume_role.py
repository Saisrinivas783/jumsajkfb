...
module makes — and the session/client caching behavior.
"""
...
from src.aws.assume_role import AssumedRoleClientFactory, CredentialsError
...
class TestRefreshMetadata:
    ...
    def test_gives_up_after_exhausting_retries(self, mock_boto_client, _mock_sleep):
        ...
        with pytest.raises(CredentialsError, match="Role assumption failed"):
